...
class ZeebeGrpcClient extends TypedEmitter_1.TypedEmitter {
    ...
    deleteResource({ resourceKey, }) {
        return this.executeOperation('deleteResourceSync', async () => (await this.grpc).deleteResourceSync({ resourceKey }));
    }
    ...
    failJob(failJobRequest) {
        return this.executeOperation('failJob', async () => (await this.grpc).failJobSync(failJobRequest));
    }
    /**
    ...
    migrateProcessInstance(migrateProcessInstanceRequest) {
        return this.executeOperation('migrateProcessInstance', async () => (await this.grpc).migrateProcessInstanceSync(migrateProcessInstanceRequest));
    }
    /**
    ...
    resolveIncident(resolveIncidentRequest) {
        return this.executeOperation('resolveIncident', async () => (await this.grpc).resolveIncidentSync(resolveIncidentRequest));
    }
    /**
     *
    ...
    setVariables(request) {
        ...
        */
        const variables = typeof request.variables === 'object'
            ...
            : request.variables;
        return this.executeOperation('setVariables', async () => (await this.grpc).setVariablesSync({ ...request, variables }));
    }
    /**
     *
    ...
    updateJobRetries(updateJobRetriesRequest) {
        return this.executeOperation('updateJobRetries', async () => (await this.grpc).updateJobRetriesSync(updateJobRetriesRequest));
    }
    /**
  ...
  Errors:
    ...
    */
    updateJobTimeout(updateJobTimeoutRequest) {
        return this.executeOperation('updateJobTimeout', async () => (await this.grpc).updateJobTimeoutSync(updateJobTimeoutRequest));
    }
